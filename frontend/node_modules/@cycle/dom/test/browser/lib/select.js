...
describe('DOMSource.select()', function () {
    it('should have Observable `:root` in DOM source', function (done) {
        function app(sources) {
            return {
                DOM: xstream_1.default.of(lib_1.div('.top-most', [lib_1.p('Foo'), lib_1.span('Bar')])),
            };
        }
    ...
    it('should select svg element', function (done) {
        function app(sources) {
            return {
                DOM: xstream_1.default.of(lib_1.svg({ attrs: { width: 150, height: 150 } }, [
                    lib_1.svg.polygon({
                        attrs: {
                            class: 'triangle',
